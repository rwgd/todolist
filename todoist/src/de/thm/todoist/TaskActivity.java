...
public class TaskActivity extends Activity implements OnClickListener, Constants  {
	
	public ListView lvTasks;
	public Button bReload, bLogout, bNew;
	...
	private void showList() {
		...
		if (actualTasks != null) {
			if (actualTasks.size() > 0) {
				...
				Bitmap greenIcon = BitmapFactory.decodeResource(getResources(), R.drawable.green);
				Bitmap redIcon = BitmapFactory.decodeResource(getResources(), R.drawable.red);
				...
				ExtendedSimpleAdapter aa = new ExtendedSimpleAdapter(this,
						myList, R.layout.row_task,
						new String[] { "task_title", "task_enddate",
								"task_done"}, new int[] {
								R.id.textViewTaskRowTitle, R.id.textViewTaskRowTillValue,
	...
	public void populateTasks(){
		...
		actualTasks.add(new Task(1, "Aufgabe1", "Beschreibung 1", "12.12.1999", false, 0));
		actualTasks.add(new Task(2, "Aufgabe2", "Beschreibung 2", "12.12.1998", false, 0));
		actualTasks.add(new Task(3, "Aufgabe3", "Beschreibung 3", "12.12.1997", true, 0));
